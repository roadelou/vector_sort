...
// Header Guard
#ifndef INSERT_SORTED_VECTOR_IMPLEMENTATION_INCLUDED
#define INSERT_SORTED_VECTOR_IMPLEMENTATION_INCLUDED
...
template <typename Sortable>
std::vector<Sortable> InsertSortedVector<Sortable>::get_frozen(void) {
